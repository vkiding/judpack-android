...
import com.alibaba.jud.commons.AbsJudActivity;
import com.alibaba.jud.commons.util.CommonUtils;
import com.alibaba.jud.commons.util.DevOptionHandler;
import com.alibaba.jud.commons.util.ShakeDetector;
import com.alibaba.jud.constants.Constants;
import com.google.zxing.integration.android.IntentIntegrator;
import com.google.zxing.integration.android.IntentResult;
import com.taobao.jud.WXEnvironment;
import com.taobao.jud.WXRenderErrorCode;
import com.taobao.jud.WXSDKEngine;
import com.taobao.jud.WXSDKInstance;
import com.taobao.jud.ui.component.NestedContainer;
import com.taobao.jud.utils.WXSoInstallMgrSdk;

import java.util.LinkedHashMap;


public class WXPageActivity extends AbsJudActivity implements
  ...
  private String getUrl(Uri uri) {
    ...
    if (uri.isHierarchical()) {
      if (TextUtils.equals(scheme, "http") || TextUtils.equals(scheme, "https")) {
        String judTpl = uri.getQueryParameter(Constants.JUD_TPL_KEY);
        if (!TextUtils.isEmpty(judTpl)) {
          url = judTpl;
        }
      }
    }
