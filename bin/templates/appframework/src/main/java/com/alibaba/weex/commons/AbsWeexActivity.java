 ...
 */
package com.alibaba.jud.commons;
...
import com.taobao.jud.IWXRenderListener;
import com.taobao.jud.WXSDKEngine;
import com.taobao.jud.WXSDKInstance;
import com.taobao.jud.common.IWXDebugProxy;
import com.taobao.jud.common.WXRenderStrategy;

import java.util.HashMap;
import java.util.Map;

public abstract class AbsJudActivity extends Activity implements IWXRenderListener {
  private static final String TAG = "AbsJudActivity";
  ...
  protected void destoryJudInstance() {
    if (mInstance != null) {
  ...
  protected void createJudInstance() {
    destoryJudInstance();
